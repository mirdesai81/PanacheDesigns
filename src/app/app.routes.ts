...
const routes : Routes = [
 ...
 {path : 'welcome', component : HomeComponent},
  ...
  {path : 'admin/category',component : CategoryFormComponent, canActivate : [LoggedInGuard], canDeactivate : [CategoryDeactivateGuard]},
  {path : 'admin/product',component : ProductFormComponent, canActivate : [LoggedInGuard], canDeactivate : [ProductDeactivateGuard]},
